...
<div class="row">
    ...
    <div class="col-md-3">
        <div class="col-md-12" align="center">
            <img class="img-responsive img-portfolio img-hover" style="width:100px;" src="{{ asset('img/fotoPerfil.png') }}">
        </div>
        <div class="col-md-12">
                    ...
                    <div class="control-group form-group">
                        <div class="controls">
                            ...
                            <span id="alertName" data-toggle="popover" data-trigger="hover" data-placement="right" title="" data-content="">
                                <input type="text" class="form-control" id="txtName" placeholder="{{ Auth::user()->name }}" required data-validation-required-message="Por favor introduzca su nombre.">
                            </span>
                            <br >
                            ...
                            <span id="alertEmail" data-toggle="popover" data-trigger="hover" data-placement="right" title="" data-content="">
                                <input type="email" class="form-control" id="txtEmail" placeholder="{{ Auth::user()->email }}" required data-validation-required-message="Por favor introduzca su email.">
                            </span>
