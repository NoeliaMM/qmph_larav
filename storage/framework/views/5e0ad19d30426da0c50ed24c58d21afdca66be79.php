...
<div class="container-fluid" id="page-content-wrapper">
    <div class="row">
        <div class="col-4 mh-100 p-5 columna-derecha">
                ...
                <a href="<?php echo e(route('formropa')); ?>" class="btn  btn-toggle" id="menu-toggle">O ¿guardamos una prenda?</a>
        ...
        <div class="col-8 mh-100 rejilla" >
                ...
                <div class="row">
                    ...
                    <img  src="<?php echo e(asset('img/prendas.png')); ?>" alt=" ">
                    </div>
                    ...
                    <div class="col-4 caja-4">
                        <img  src="<?php echo e(asset('img/percharosa.png')); ?>" alt=" ">
                    </div>
                </div>
                <div class="row">
...
<script src="<?php echo e(asset('js/apiGeoWheather.js')); ?>"></script>
